...
namespace QHAQFWS.Core.Sync
{
    public class StationAirQualityHourlySourceStandardDataSync : SyncBase<Air_StationAQIHistory_H_Src_Std>
    {
        ...
        protected override List<Air_StationAQIHistory_H_Src_Std> GetSyncData(DateTime time)
        {
            ...
            {
                SiteDaily[] srcList = client.GetSiteHoursData(time, time, (int)AirQualityDataType.SourceStandard);
        ...
        {
            return Model.Air_StationAQIHistory_H_Src_Std.Count(o => o.TimePoint == time) + 15 > StationList.Count;
        }

        protected override void RemoveData(DateTime time)
        {
            IQueryable<Air_StationAQIHistory_H_Src_Std> list = Model.Air_StationAQIHistory_H_Src_Std.Where(o => o.TimePoint == time);
            if (list.Any())
            {
                Model.Air_StationAQIHistory_H_Src_Std.RemoveRange(list);
            }
        }
    }
}
