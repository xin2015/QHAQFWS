namespace QHAQFWS.Model
{
	...
	public partial class Weather_D_SpiData
	{
		private int _id;
		...
		private decimal? _lowTemperature;
		public virtual decimal? LowTemperature
		{
			get
			{
			...
			set
			{
				this._lowTemperature = value;
			}
		}

		private decimal? _highTemperature;
		public virtual decimal? HighTemperature
		{
			get
			{
